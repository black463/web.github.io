...
<body class="min-h-screen bg-gray-100 p-4">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-xl border border-gray-200">
        ...
        <div class="mb-8 p-6 bg-green-50 rounded-lg border border-green-200 shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <!-- New fields for video background/environment -->
                <div class="flex flex-col">
    ...
    <script>
        ...
        function generatePrompt() {
            let parts = [];
            const mainPromptValue = mainPromptInput.value;
            if (mainPromptValue) {
            ...
            if (faceDetails) {
                // Capitalize the first letter of the combined face details
            ...
            const videoDetails = [
                ...
                characterActionInput.value ? `character action: ${characterActionInput.value}` : '',
                ...
                visualEffectsInput.value ? `visual effects: ${visualEffectsInput.value}` : '',
            ].filter(Boolean).join(', ');
        ...
        async function enhancePrompt() {
            ...
            try {
                const chatHistory = [];
                const promptForLLM = `Improve the following image and video generation prompt by adding more details, descriptive adjectives, and artistic elements to make it richer and more effective for generating high-quality visuals. For video, specifically suggest details for motion, camera angles, scene transitions, character actions, background environment, time of day/season, weather conditions, and visual effects. The original prompt is: "${currentPrompt}"`;
